  ...
  return (
    <div className="h-full flex flex-col p-6 max-w-7xl mx-auto w-full">
      <div className="flex-shrink-0 mb-4">
        <h1 className="text-2xl font-bold text-gray-800">注文書送信履歴</h1>
        <p className="text-xs text-gray-400 mt-1">メール / 郵送 の送信ログ（注文書＋注文請書）</p>
      </div>
      ...
      <div className="flex-shrink-0 flex flex-wrap items-end gap-3 mb-4 bg-white p-4 rounded-lg border border-gray-200">
        ...
        <div className="flex-1 min-w-[200px]">
          ...
          <Input type="text" placeholder="注文番号・取引先・件名" value={q} onChange={(e) => setQ(e.target.value)} />
        </div>
